/**
 * Derived from pi-web-access v0.14.0 — rsc-extract.ts
 * https://github.com/nicobailon/pi-web-access
 * Copyright (c) 2025 Nico Bailon. MIT — see NOTICE.
 * Modifications Copyright (c) 2026 pacoyang. MIT.
 *
 * Copied rather than rewritten: Next.js RSC flight data is an undocumented
 * format that was reverse-engineered. Rewriting would mean reverse-engineering
 * it again for no gain.
 */
